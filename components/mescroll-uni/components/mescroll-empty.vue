...
<template>
	<view class="mescroll-empty" :class="{ 'empty-fixed': option.fixed }" :style="{ 'z-index': option.zIndex, top: option.top }">
		<view> <image  class="empty-icon" src="../../../static/images/no-data.png" mode="widthFix" /> </view>
		<view v-if="tip" class="empty-tip">{{ tip }}</view>
		<view v-if="option.btnText" hover-class="empty-btn-active" class="empty-btn" @click="emptyClick">{{ option.btnText }}</view>
	</view>
</template>
