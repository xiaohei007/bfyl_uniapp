...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"彬纷享礼","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 10:
/*!**********************************!*\
  !*** E:/小黑办公/学习项目/utils/http.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports._startLoading = _startLoading;exports._closeLoading = _closeLoading;exports.HTTP = exports.socket = exports.fileBaseUrl = exports.baseUrl = void 0;var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 11));
var _index = __webpack_require__(/*! @/utils/index */ 17);


var _log = _interopRequireDefault(__webpack_require__(/*! @/utils/log.js */ 18));
var _routerIntercept = __webpack_require__(/*! @/utils/routerIntercept.js */ 24);
...
var _httpErrMsg = __webpack_require__(/*! @/utils/httpErrMsg.js */ 25);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var baseUrl = "https://new-test.y1b.cn"; //测试
exports.baseUrl = baseUrl;var fileBaseUrl = "https://test-file.y1b.cn"; //测试
exports.fileBaseUrl = fileBaseUrl;var socket = "wss://new-test.y1b.cn/wss/"; //测试
...
//默认请求头
exports.socket = socket;var defaultHeader = {
...
function _res(response, config) {//响应拦截
  ...
  //只打印异常情况
  if (!(0, _httpErrMsg.isHttpErrMsg)(response.errMsg)) {
    _log.default.setFilterMsg('网络请求异常');
    _log.default.warn('请求接口：' + config.url);
...
XHService.prototype._request = function (config) {var _this = this;
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (config.isCache) {
      //从本地获取缓存
      var cache = (0, _auth.getStorage)(config.url);
    ...
    uni.request({
      ...
      complete: function complete(response) {
        ...
        if (res == -3) {
          ...
          errMsg = (0, _httpErrMsg.getHttpErrMsg)(response.errMsg);
          //异常状态码
...
function _setCacheData(res, url) {
  ...
  if (res.code == 1 && res.data) {
    //添加缓存
    (0, _auth.setStorage)(url, JSON.stringify({
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  ...
  wxUserInfo: function wxUserInfo(state) {return state.login.wxUserInfo;},
  uid: function uid(state) {return state.login.uid;},
  //系统相关
...
/***/ 128:
/*!**************************************!*\
  !*** E:/小黑办公/学习项目/utils/xhNavbar.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getNavbarData = getNavbarData; /*获取 Navbar navBarHeight statusBarHeight menuWidth*/
function getNavbarData() {

  return new Promise(function (resolve, reject) {
    /*从本地获取navbar 信息*/
    var data = wx.getStorageSync('xh-navbar-system');
    //有缓存直接返回
    ...
    wx.getSystemInfo({
      success: function success(res) {var
        statusBarHeight = res.statusBarHeight,system = res.system;
        var menuButton = null;
        try {
        ...
        menuButton = menuButton || { left: 110 };
        //导航栏高度 android = 48 ios = 44
        var navBarHeight = /ios/.test(system.toLocaleLowerCase()) ? 44 : 48;
        //胶囊宽度
        var menuWidth = res.windowWidth - menuButton.left + 10;
...
/***/ 13:
/*!*********************************************!*\
  !*** E:/小黑办公/学习项目/store/modules sync \.js$ ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!*****************************************!*\
  !*** E:/小黑办公/学习项目/store/modules/app.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!*******************************************!*\
  !*** E:/小黑办公/学习项目/store/modules/login.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _getUserLocation = __webpack_require__(/*! @/utils/getUserLocation.js */ 20);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var state = {
  ...
  wxUserInfo: (0, _auth.getWxUserInfo)(),
  token: (0, _auth.getToken)() || "", //token
  userLocation: (0, _auth.getLocation)(),
  uid: '' };
...
var mutations = {
  logout: function logout(state) {//退出登录
    state.token = '';
    state.userInfo = null;
    (0, _auth.removeWxUserInfo)();
    (0, _auth.removeGetUserInfo)();
    (0, _auth.removeToken)();
  },
  ...
  setWxUserInfo: function setWxUserInfo(state, wxUserInfo) {
    state.wxUserInfo = wxUserInfo;
    (0, _auth.setWxUserInfo)(wxUserInfo || {});
  },
...
var actions = {
    ...
    return new Promise(function (resolve, reject) {
      ...
      uni.getUserInfo({
        ...
        success: function success(infoRes) {
          //存储微信api返回的用户信息
          (0, _auth.setWxUserInfo)(infoRes.userInfo);
          //获取用户定位信息
          (0, _getUserLocation.getUserLocation)(true).then(function (data) {
            //保存用户定位信息
            if (!data.isold) commit('setUserLocation', data.data);
  ...
  //更新用户手机
  updateUserMobile: function updateUserMobile(_ref5,


  e) {var commit = _ref5.commit,state = _ref5.state;
    ...
    return new Promise(function (resolve, reject) {
      ...
      reject();
      _log.default.setFilterMsg('getUserMobile');
      _log.default.info("getUserMobile error==>" + JSON.stringify(e.detail));
    });
...
/***/ 16:
/*!**********************************!*\
  !*** E:/小黑办公/学习项目/utils/auth.js ***!
  \**********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.setToken = setToken;exports.getToken = getToken;exports.removeToken = removeToken;exports.setWxScanQrCode = setWxScanQrCode;exports.getWxScanQrCode = getWxScanQrCode;exports.removeWxScanQrCode = removeWxScanQrCode;exports.getUserInfo = getUserInfo;exports.removeGetUserInfo = removeGetUserInfo;exports.setWxUserInfo = setWxUserInfo;exports.getWxUserInfo = getWxUserInfo;exports.removeWxUserInfo = removeWxUserInfo;exports.getLocation = getLocation;exports.setStorage = setStorage;exports.getStorage = getStorage;
var baseUrl = "https://txc.y1b.cn";
...
function getUserInfo() {
  var userInfo = getStorage(baseUrl + '/api2/cuser/getuser');
  if (userInfo) {
...
function getWxUserInfo() {
  var userInfo = getStorage('wxUserInfo');
  if (userInfo) {
...
function removeWxUserInfo() {
  uni.removeStorageSync('wxUserInfo');
}

/*获取经纬度*/
function getLocation() {
  var cache = getStorage('getUserLocation');
  cache = cache && JSON.parse(cache);
...
/***/ 17:
/*!***********************************!*\
  !*** E:/小黑办公/学习项目/utils/index.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.parseQuery = parseQuery;exports.filterAdData = filterAdData;exports.debounce = debounce;exports.VALID_CACHE = VALID_CACHE;exports.PLAQUEADVERTISING = PLAQUEADVERTISING;exports.xhAudio = xhAudio;exports.xhCheckSession = xhCheckSession;exports.parseTime = parseTime;var _log = _interopRequireDefault(__webpack_require__(/*! @/utils/log.js */ 18));
...
//转化url地址
function parseQuery() {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var o = {};
...
function xhCheckSession(isNoSession) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (!_store.default.getters.token) return reject();
...
/***/ 186:
/*!***************************************************************!*\
  !*** E:/小黑办公/学习项目/components/mescroll-uni/mescroll-mixins.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 19:
/*!*********************************!*\
  !*** E:/小黑办公/学习项目/api/login.js ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.wxLogin = wxLogin;exports.updateUser = updateUser;exports.getUser = getUser;exports.getUserMobile = getUserMobile;exports.userprofile = userprofile;var _http = __webpack_require__(/*! @/utils/http.js */ 10);
...
/***/ 20:
/*!*********************************************!*\
  !*** E:/小黑办公/学习项目/utils/getUserLocation.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getUserLocation = getUserLocation;var _auth = __webpack_require__(/*! @/utils/auth.js */ 16);



var _coordtransform = __webpack_require__(/*! ./coordtransform.js */ 21);
var _index = __webpack_require__(/*! ./index.js */ 17);
var _log = _interopRequireDefault(__webpack_require__(/*! @/utils/log.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
// import {
...
function getUserLocation() {var isFailBack = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  return new Promise(function (resolve, reject) {
    var cache = (0, _auth.getStorage)('getUserLocation');
    cache = cache && JSON.parse(cache);
    //判断是否有缓存，并且在缓存有效期
    if (cache && (0, _index.VALID_CACHE)(cache.prescription || 120, cache.lastModified)) {
      //关闭loading
      // _closeLoading()
      return resolve({
        data: cache.data,
    ...
    uni.getLocation({
      ...
      success: function success(res) {
        ...
        //坐标转化
        var parmas = (0, _coordtransform.wgs84togcj02)(res.longitude, res.latitude);
      ...
      fail: function fail(err) {
        ...
        // _closeLoading()
        //只打印异常情况
        _log.default.setFilterMsg('getLocation');
        _log.default.error('getLocation：' + JSON.stringify(err));
...
/***/ 21:
/*!********************************************!*\
  !*** E:/小黑办公/学习项目/utils/coordtransform.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.wgs84togcj02 = wgs84togcj02;
//定义一些常量
...
/***/ 22:
/*!**********************************************!*\
  !*** E:/小黑办公/学习项目/store/modules/personal.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _homeApi = __webpack_require__(/*! @/api/homeApi.js */ 23);
...
var actions = {
  //获取广告数据
  getAdData: function getAdData(_ref)

  {var commit = _ref.commit;
    (0, _homeApi.adGet)().then(function (res) {
      var data = res.data;
      if (res.code == 1 && data) {
...
/***/ 23:
/*!***********************************!*\
  !*** E:/小黑办公/学习项目/api/homeApi.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.adGet = adGet;exports.getArticle = getArticle;exports.givelike = givelike;var _http = __webpack_require__(/*! @/utils/http.js */ 10);
...
/***/ 24:
/*!*********************************************!*\
  !*** E:/小黑办公/学习项目/utils/routerIntercept.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//路由白名单
var whiteList = ['/pages/tabBar/service/service', '/pages/tabBar/personal/index',
...
/***/ 25:
/*!****************************************!*\
  !*** E:/小黑办公/学习项目/utils/httpErrMsg.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getHttpErrMsg = getHttpErrMsg;exports.isHttpErrMsg = isHttpErrMsg;function getHttpErrMsg(errMsg) {

  return httpErrMsg[errMsg] || errMsg.replace(/(request:fail)|(。)/g, "");

}

function isHttpErrMsg(errMsg) {
...
/***/ 86:
/*!************************************************************!*\
  !*** E:/小黑办公/学习项目/components/mescroll-uni/mescroll-uni.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 87:
/*!*******************************************************************!*\
  !*** E:/小黑办公/学习项目/components/mescroll-uni/mescroll-uni-option.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 88:
/*!**********************************************************!*\
  !*** E:/小黑办公/学习项目/components/mescroll-uni/wxs/mixins.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 9:
/*!************************************!*\
  !*** E:/小黑办公/学习项目/utils/socket.js ***!
  \************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.socketConnect = socketConnect;exports.appShowSendMessage = appShowSendMessage;exports.appHideSendMessage = appHideSendMessage;exports.closeSocket = closeSocket;exports.sendMessage = sendMessage;var _http = __webpack_require__(/*! @/utils/http */ 10);
...
function socketConnect() {
  ...
  /*发起连接*/
  wx.connectSocket({
    url: _http.socket //baseUrl.replace('https', 'wss') + '/wss/'
  });
  /*连接打开事件的回调函数*/
  wx.onSocketOpen(function (res) {
    ...
    /*没有token直接调关闭*/
    if (!_store.default.getters.token) return closeSocket();
    //获取用户信息
    var accountInfo = wx.getAccountInfoSync ? wx.getAccountInfoSync() : { miniProgram: { version: '' } };
    //获取设备信息
    wx.getSystemInfo({
      success: function success(res) {
        res['token'] = _store.default.getters.token;
  ...
  wx.onSocketMessage(function (res) {
    ...
    var tempSocket = JSON.parse(res.data);
