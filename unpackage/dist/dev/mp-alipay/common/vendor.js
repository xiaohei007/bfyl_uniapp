...
/***/ 12:
/*!********************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!**********************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/getters.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  //登录相关
  token: function token(state) {return state.login.token;},
  userLocation: function userLocation(state) {return state.login.userLocation;},
  userInfo: function userInfo(state) {return state.login.userInfo;},
  //系统相关
  isConnected: function isConnected(state) {return state.app.isConnected;},
  deviceInfo: function deviceInfo(state) {return state.app.deviceInfo;},
  // 一元轻松享相关
  checkCardVolume: function checkCardVolume(state) {return state.personal.checkCardVolume;},
  statistics: function statistics(state) {return state.personal.statistics;},
  adData: function adData(state) {return state.personal.adData;} };var _default =
...
/***/ 14:
/*!******************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/modules sync \.js$ ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 148:
/*!*********************************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/components/mescroll-uni/mescroll-uni.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 149:
/*!****************************************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/components/mescroll-uni/mescroll-uni-option.js ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!**************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/modules/app.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _auth = __webpack_require__(/*! @/utils/auth.js */ 16);
...
var state = {
  ...
  deviceInfo: (0, _auth.getDeviceInfo)() //设备信息
};

var mutations = {
  setConnected: function setConnected(state, isConnected) {//网络状态
    state.isConnected = isConnected;
  },
  setDeviceInfo: function setDeviceInfo(state, data) {//设备信息
    state.deviceInfo = data;
    (0, _auth.setDeviceInfo)(data);
  } };
  ...
  {var commit = _ref.commit;
    ...
    uni.getSystemInfo({
      success: function success(res) {
        ...
        if (res.errMsg === 'getSystemInfo:ok') {var
          ...
          res.system,model = res.model,pixelRatio = res.pixelRatio,windowWidth = res.windowWidth,windowHeight = res.windowHeight,version = res.version,SDKVersion = res.SDKVersion,statusBarHeight = res.statusBarHeight,deviceOrientation = res.deviceOrientation;
...
/***/ 150:
/*!*******************************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/components/mescroll-uni/wxs/mixins.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 16:
/*!*******************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/utils/auth.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.setToken = setToken;exports.getToken = getToken;exports.setWxScanQrCode = setWxScanQrCode;exports.getWxScanQrCode = getWxScanQrCode;exports.removeWxScanQrCode = removeWxScanQrCode;exports.setUserInfo = setUserInfo;exports.getUserInfo = getUserInfo;exports.setDeviceInfo = setDeviceInfo;exports.getDeviceInfo = getDeviceInfo;exports.getLocation = getLocation;exports.cacheAdData = cacheAdData;exports.cacheArticle = cacheArticle; /*token*/
...
/*微信扫拉环进入时的二维码值*/
function setWxScanQrCode(data) {
  return uni.setStorageSync('wxScanQrCode', data);
}
function getWxScanQrCode() {
  return uni.getStorageSync('wxScanQrCode');
}
function removeWxScanQrCode() {
  return uni.removeStorageSync('wxScanQrCode');
}
...
function setDeviceInfo(data) {
  ...
  return uni.setStorageSync('deviceInfo', JSON.stringify(data));
}
function getDeviceInfo() {
  var deviceInfo = uni.getStorageSync('deviceInfo');
  if (deviceInfo) {
...
function getLocation() {
  var cache = uni.getStorageSync('getUserLocation');
  cache = cache && JSON.parse(cache);
  return cache && cache.data;
}

//获取广告
function cacheAdData() {
  var cache = uni.getStorageSync('https://txc.y1b.cn/api/ad/get');
  if (cache) {
...
function cacheArticle() {
  var cache = uni.getStorageSync('https://txc.y1b.cn/api2/ctools/article');
  if (cache) {
    var data = JSON.parse(cache).data.list;
...
/***/ 17:
/*!****************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/modules/login.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _login = __webpack_require__(/*! @/api/login.js */ 20);function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
var state = {
  userInfo: (0, _auth.getUserInfo)(), //用户信息
  token: (0, _auth.getToken)() || "", //token
  userLocation: (0, _auth.getLocation)() //用户定位信息
};
...
var mutations = {
  ...
  setToken: function setToken(state, token) {//token
    state.token = token;
    (0, _auth.setToken)(token);
  },
  setUserInfo: function setUserInfo(state, userInfo) {//用户信息
    state.userInfo = userInfo;
    (0, _auth.setUserInfo)(userInfo || {});
  },
  setUserLocation: function setUserLocation(state, data) {//用户定位信息
...
var actions = {
  ...
  {var commit = _ref.commit;var isNoSession = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return new Promise(function (resolve, reject) {

      (0, _index.xhCheckSession)(isNoSession).then(function () {
  ...
  {var commit = _ref2.commit;var isMobile = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    (0, _login.getUser)().then(function (res) {
      if (res.code == 1) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      uni.getUserInfo({
        ...
        success: function success(infoRes) {
          ...
          // console.log(infoRes)
          //获取用户定位信息
          (0, _index.getUserLocation)(true).then(function (data) {
            //保存用户定位信息
            if (!data.isold) commit('setUserLocation', data.data);
            //传给后端
            (0, _login.updateUser)(_objectSpread({
  ...
  //更新用户手机
  updateUserMobile: function updateUserMobile(_ref4,


  e) {var commit = _ref4.commit,state = _ref4.state;
    ...
    return new Promise(function (resolve, reject) {
      ...
      e.detail,iv = _e$detail.iv,encryptedData = _e$detail.encryptedData;
...
/***/ 18:
/*!********************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/utils/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.parseQuery = parseQuery;exports.setParmasData = setParmasData;exports.debounce = debounce;exports.getUserLocation = getUserLocation;exports.VALID_CACHE = VALID_CACHE;exports.filterAdData = filterAdData;exports.PLAQUEADVERTISING = PLAQUEADVERTISING;exports.xhAudio = xhAudio;exports.xhCheckSession = xhCheckSession;var _log = _interopRequireDefault(__webpack_require__(/*! @/utils/log.js */ 19));
...
function parseQuery(url) {
  ...
  if (queryString) {
    queryString.
    split('&').
    forEach(function (item) {var _item$split =
      item.split('='),_item$split2 = _slicedToArray(_item$split, 2),key = _item$split2[0],val = _item$split2[1];
...
//组合支付数据
function setParmasData(arr, key, value) {
  var o = {};
...
//获取用户定位信息
function getUserLocation() {var isFailBack = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

  return new Promise(function (resolve, reject) {
    var cache = uni.getStorageSync('getUserLocation');
    cache = cache && JSON.parse(cache);
    if (cache && VALID_CACHE(60 * 2, cache.lastModified)) {
      // console.log('用户定位信息，30分钟内有效')
      return resolve({
        data: cache.data,
        isold: true });
    ...
    uni.getLocation({
      ...
      success: function success(res) {
        ...
        //缓存数据
        uni.setStorageSync('getUserLocation', JSON.stringify({
...
//filter广告数据
function filterAdData() {var arr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];var key = arguments.length > 1 ? arguments[1] : undefined;
  var _arr = [];
...
//插屏广告
function PLAQUEADVERTISING() {var option = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  return {
    interstitialAd: null,
    init: function init(adUnitId) {var _this = this;
      ...
      if (uni.createInterstitialAd) {
        ...
        this.interstitialAd.onError(function (err) {
          if (_this.interstitialAd) {
            _this.interstitialAd.destroy(); //销毁实列
          }
          _this.interstitialAd = uni.createInterstitialAd({
            adUnitId: adUnitId });
...
//音频播放
function xhAudio(config) {//url,onPlay,onError,onEnded
  ...
  return {
    ...
    play: function play(url) {//播放
      //有新值，赋值播放
      if (url) this.innerAudioContext.src = config.url;
      //直接播放
      this.innerAudioContext.play();
    },
    pause: function pause() {//暂停
      this.innerAudioContext.pause();
    },
    stop: function stop() {//停止
      this.innerAudioContext.stop();
    },
    seek: function seek(_seek) {//设置进度
      this.innerAudioContext.seek = _seek;
    },
...
//判断用户Session 是否过期
function xhCheckSession(isNoSession) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    uni.checkSession({
      ...
      fail: function fail(res) {
        reject();
        //只打印异常情况
        _log.default.setFilterMsg('checkSession');
        _log.default.error('响应结果：' + JSON.stringify(res));
      } });
...
/***/ 19:
/*!******************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/utils/log.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 20:
/*!******************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/api/login.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.wxLogin = wxLogin;exports.updateUser = updateUser;exports.getUser = getUser;exports.getUserMobile = getUserMobile;var _http = __webpack_require__(/*! @/utils/http.js */ 21);

//微信登录
function wxLogin(data) {
  return _http.HTTP.post({
...
/***/ 21:
/*!*******************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/utils/http.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni, wx) {Object.defineProperty(exports, "__esModule", { value: true });exports.HTTP = exports.fileBaseUrl = exports.baseUrl = void 0;var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 12));
var _index = __webpack_require__(/*! @/utils/index */ 18);


var _log = _interopRequireDefault(__webpack_require__(/*! @/utils/log.js */ 19));
var _routerIntercept = __webpack_require__(/*! @/utils/routerIntercept.js */ 22);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var baseUrl = "https://txc.y1b.cn"; //正式
exports.baseUrl = baseUrl;var fileBaseUrl = "https://file.y1b.cn"; //正式

//默认请求头
exports.fileBaseUrl = fileBaseUrl;var defaultHeader = {
...
function _res(response, config) {//响应拦截
  ...
  if (response.statusCode == 200) {
    ...
    if (result.code == -1 || result.code == 5) {
      //清除登录信息
      _store.default.commit('login/logout');
      //如果当前页面为登录页
      if (_routerIntercept.nextRouterPath == '/pages/login/login') {
        return; //防止跳转当前页
      }
      //用户提示
      uni.showToast({
  ...
  //只打印异常情况
  _log.default.setFilterMsg('请求接口：' + config.url);
  _log.default.warn('请求参数：' + JSON.stringify(config));
  _log.default.warn('设备信息：' + JSON.stringify(_store.default.getters.deviceInfo));
  _log.default.error('响应结果：' + JSON.stringify(response));
  return -3; //请求异常情况
}
//请求函数
XHService.prototype._request = function (config) {var _this = this;
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (config.isCache) {
      //从本地获取缓存
      var cache = uni.getStorageSync(config.url);
      cache = cache && JSON.parse(cache);
      //有缓存并且在缓存有效期
      if (cache && (0, _index.VALID_CACHE)(config.cacheMaxAge || _cacheTime, cache.lastModified)) {
        //关闭loading
        if (!config.isNoLoading) _closeLoading();
    ...
    uni.request({
      ...
      complete: function complete(response) {
        ...
        if (_this.interceptor.response) {
          res = _this.interceptor.response(res, config);
        }
        //登录失效情况则不处理
        if (res == -2) return;
        //异常情况
        if (res == -3) {
          ...
          _msg = statusCode + '';
          //防止statusCode === 0 时 无信息提示
          if (!statusCode && statusCode !== 0) _msg = errMsg.replace('request:fail', '').replace('。', '');
          //提示给用户   
          wx.showModal({
            title: '请求异常',
            content: _msg === '请求超时' ? '网络缓慢，请求超时' : _msg,
            showCancel: false });

          return reject(response);
        };
        //是缓存接口类型 --> 添加缓存
        if (config.type === 'cache') _setCacheData(res, config.url);
        //正确情况
        resolve(res);
      } });
...
/***/ 22:
/*!******************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/utils/routerIntercept.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.clearRedirect = clearRedirect;exports.redirect = exports.nextRouterPath = exports.router = void 0;var _auth = __webpack_require__(/*! ./auth.js */ 16);


//路由黑名单 未登录页面不允许跳转
var whiteList = ['/pages/tabBar/service/service', '/pages/tabBar/personal/index', '/pages/tabBar/happyCows/happyCows',
'/pages/login/login', '/pages/webview/webview'];
...
//上一个页面的path
exports.router = router;var nextRouterPath = '';
//保存登录成功后重定向页面
exports.nextRouterPath = nextRouterPath;var redirect = '';
//清空重定向记录
exports.redirect = redirect;function clearRedirect() {
...
function routeDetection(config) {
  return new Promise(function (resolve, reject) {
    //登录校验
    var isLogin = Boolean((0, _auth.getToken)());
    exports.nextRouterPath = nextRouterPath = config.url;
    //没在白名单里就跳转登录
    if (whiteList.findIndex(function (item) {return item === config.url.replace(/\?.+/, '');}) == -1) {
      //保存登录成功后跳转页
      exports.redirect = redirect = config.url;
      //是否登录
      if (!isLogin) {
        uni.reLaunch({
          url: '/pages/login/login' });
    ...
    exports.redirect = redirect = ''; //其它就设置为空
    //正常访问
    resolve();
  });
}
...
/***/ 228:
/*!************************************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/components/mescroll-uni/mescroll-mixins.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!*******************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/store/modules/personal.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _homeApi = __webpack_require__(/*! @/api/homeApi.js */ 24);
...
var _auth = __webpack_require__(/*! @/utils/auth.js */ 16);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}



var state = {
  checkCardVolume: [], //当前选中待兑奖数据
  adData: (0, _auth.cacheAdData)(), //广告数据
  statistics: {} //统计
};

var mutations = {
  setCheckCardVolume: function setCheckCardVolume(state, data) {//选中的待兑奖卷
    state.checkCardVolume = data;
  },
  setStatistics: function setStatistics(state, data) {//首页与卡包统计
    state.statistics = data;
  },
  setAdData: function setAdData(state, data) {//广告数据
...
var actions = {
  //微信支付
  wxplay: function wxplay(_ref,

  parmas) {var commit = _ref.commit;

    return new Promise(function (resolve, reject) {

      (0, _homeApi.createcardpay)(parmas).then(function (res) {
        ...
        uni.requestPayment({
          ...
          success: function success(res) {
            ...
            //打印日志
            _log.default.setFilterMsg('微信支付 requestPayment');
            _log.default.info("requestPayment success==>" + JSON.stringify(res));
          },
          fail: function fail(err) {
            reject(err);
            //打印日志
            _log.default.setFilterMsg('微信支付 requestPayment');
            _log.default.error("requestPayment fail==>" + JSON.stringify(err));
          } });
  ...
  //获取顶部统计 
  getCardTopCount: function getCardTopCount(_ref2)

  {var commit = _ref2.commit;
    //C卡包顶部统计
    (0, _homeApi.getcardcount)().then(function (res) {
      if (res.code == 1) {
  ...
  //获取广告数据
  getAdData: function getAdData(_ref3)

  {var commit = _ref3.commit;var isCache = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

    return new Promise(function (resolve, reject) {
      (0, _homeApi.adGet)(isCache).then(function (res) {
        var data = res.data;
        if (res.code == 1 && data) {
...
/***/ 24:
/*!********************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/api/homeApi.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.createcardpay = createcardpay;exports.cscanQr = cscanQr;exports.getcardlog = getcardlog;exports.getcardcount = getcardcount;exports.checkshopsid = checkshopsid;exports.getcardpack = getcardpack;exports.cscanBotqr = cscanBotqr;exports.cscanPoll = cscanPoll;exports.ctoolsIshide = ctoolsIshide;exports.adGet = adGet;exports.ccardExpirepage = ccardExpirepage;exports.getcardqr = getcardqr;exports.getArticle = getArticle;exports.givelike = givelike;exports.getnearby = getnearby;var _http = __webpack_require__(/*! @/utils/http.js */ 21);

//C发起支付
function createcardpay(data) {
...
//我的卡包 
function getcardlog(data) {

  return _http.HTTP.post({
    url: '/api2/ccard/getcardlog',
    data: data,
    isNoLoading: true });
...
//获取广告地址
function adGet() {var isCache = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  return _http.HTTP.post({
    url: '/api/ad/get',
    data: {
      app: 1 },
...
//根据订单号生成二维码 
function getcardqr(data) {
  return _http.HTTP.post({
    url: '/api2/ctools/getcardqr',
    data: data });


}
//获取新闻列表 
function getArticle(data) {var flag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  return _http.HTTP.post({
...
/***/ 271:
/*!**********************************************************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/components/mescroll-uni/mixins/mescroll-more-item.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
MescrollMoreItemMixin;exports.default = _default;
...
/***/ 4:
/*!****************************************************!*\
  !*** E:/work/works/彬纷享你小程序/bfEnjoyYour/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
