<template>
	<view class="currency-list">
		...
		<mescroll-uni ref="mescrollRef" height="100%" @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @emptyclick="emptyClick">
			<!-- 品牌或活动 -->
			<view class="currency-item" v-for="(item,index) in config" hover-class="currency-item-hover" :key="index">
				<easy-loadimage :link="item.link" path="/pages/tabBar/home/index" imageClass="news-imageclass" mode="aspectFill" @imageClick="previewImage"
